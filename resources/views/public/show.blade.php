                    ...
                    @foreach ($article->comments as $comment)
                        <div class="mt-3 p-6 bg-gray-100 rounded-lg">
                            <div class="flex flex-inline">
                                ...
                                <a href="/comments/{{$comment->id}}/remove" class="font-bold py-2 px-4 rounded text-center m-3" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce commentaire ?');">
